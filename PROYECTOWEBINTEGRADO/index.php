...
<?php include 'Conexion/conexion.php'; ?>
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            ...
            <a class="titnavv" href="index.php">
                <h1 class="titnav">Tortas Techi´s</h1>
            </a>
            <div class="collapse navbar-collapse" id="navbarColor01">
                <ul class="itemsnav navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="HTML/CARTA/tortas.php">Carta</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="OPCPC">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    <a class="dropdown-item" href="HTML/FORMS-LOGIN-REGISTRO/login.php">Iniciar Sesion</a>
                    <a class="dropdown-item" href="HTML/FORMS-LOGIN-REGISTRO/registro.php">Registrarme</a>
                </div>
            </div>
        </div>
    </nav>
...
<footer>
    <div class="divfooter">
        ...
        <a class="itemsfooter" href="#" id="libroReclamaciones">Libro de reclamaciones</a>
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const libroReclamaciones = document.getElementById("libroReclamaciones");

  libroReclamaciones.addEventListener("click", function (e) {
    e.preventDefault(); // Evitar que se siga el enlace
    
    <?php
    if (!isset($_SESSION['user'])) {
      echo "alert('Debes iniciar sesión antes de acceder al libro de reclamaciones.');";
      echo "window.location.href = 'HTML/libroreclamaciones.php';"; // Reemplaza 'ruta_del_libro_de_reclamaciones.php' por la URL real
